...
plt.savefig("LV_QoI_x_training.pdf", format="pdf", bbox_inches="tight", pad_inches=0.4)
...
plt.savefig("LV_QoI_y_training.pdf", format="pdf", bbox_inches="tight", pad_inches=0.4)
