...
ax1.set_ylabel(r"$\delta$", fontsize = 18)
ax1.set_zlabel(r"QoI$(\gamma,\delta)_x$", fontsize = 18)
ax1.zaxis.set_major_locator(MaxNLocator(integer=True))
plt.savefig("LV_QoI_x_DNN.pdf", format="pdf", bbox_inches="tight", pad_inches=0.4)
...
ax1.set_xlabel(r"$\gamma$", fontsize = 18)
ax1.set_ylabel(r"$\delta$", fontsize = 18)
ax1.set_zlabel(r"QoI$(\gamma,\delta)_y$", fontsize = 18)
ax1.zaxis.set_major_locator(MaxNLocator(integer=True))
plt.savefig("LV_QoI_y_DNN.pdf", format="pdf", bbox_inches="tight", pad_inches=0.4)
...
cbar = plt.colorbar(contour, label="Error Magnitude")
cbar.ax.set_ylabel("Error Magnitude", fontsize=18) 
