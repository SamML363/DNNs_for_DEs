...
def func_map(x, y):
    return [(np.sin(np.pi * x_i) * np.sin(2 * np.pi * y_i)) if 
...
fig.savefig("Peicewise_LM_exact_sol.png")
...
ax.set_title("DNN Approximation")
fig.savefig("Peicewise_LM_approx_sol.png")
