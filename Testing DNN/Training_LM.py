...
Nodes_2 = 3 # int(input("Input number of nodes for layer 2: "))  
Nodes_3 = 1
...
W_1 = W_1.flatten() # size: 2 x 2 or (2 x node 1)
W_2 = W_2.flatten() # size: 3 x 2 or (Node 2 x node 1)
W_3 = W_3.flatten() # size: 2 x 3 or (2 x node 2)
...
#%% Optimise Theta using Training data and scipys LM algorithm
